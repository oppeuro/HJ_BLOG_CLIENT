  ...
  <div >
    ...
    <div class="container">
      <div class="row">
        ...
        <nav class="my_nav">
          <ul class="pager">
            <li class="previous"><a @click.stop="_gotoPage"><span aria-hidden="true">&larr;</span> Prev</a></li>
            <li class="next"><a @click.stop="_gotoPage">Next <span aria-hidden="true">&rarr;</span></a></li>
          </ul>
        </nav>
      </div>
    </div>
