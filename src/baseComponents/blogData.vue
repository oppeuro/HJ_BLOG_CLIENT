...
<style lang="scss">
  ...
  .blog{min-width: 300px;  margin-bottom: 60px; border-radius: 5px; box-shadow: 0 1px 6px rgba(0,0,0,.117647), 0 1px 4px rgba(0,0,0,.117647);}
  ...
  .blog_data{padding: 16px; background-color: white;
